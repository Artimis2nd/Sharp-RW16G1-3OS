...
7. ตอบ:
   - Install GRUB? → **Yes**
   - Install EFI GRUB? → **Yes**
8. เลือก **Read/Write** (RW)

---

## ⚠️ หมายเหตุสำคัญเกี่ยวกับ GRUB

- Bliss OS จะติดตั้ง **GRUB ของตัวเอง**
- ขั้นตอนนี้ **ยอมให้ติดตั้งไปก่อน**
- ภายหลัง:
  - rEFInd จะเป็นตัวจัดการ boot หลัก
  - GRUB จะถูกเรียกผ่าน rEFInd

> อย่าพยายามลบ GRUB ตอนนี้  
> จะทำให้ Bliss OS บูตไม่ได้
...
- หน้าจอกลับด้าน / หมุนผิด  
  → แก้ภายหลังด้วย build.prop
- เสียงไม่ออก  
  → ใช้ USB sound หรือปรับ ALSA
- บูตชน Windows  
  → ยังไม่ต้องแก้ (rEFInd จะจัดการทีหลัง)
...
- ❌ ยังไม่ต้องลบ GRUB
- ❌ ยังไม่ต้องปรับ boot order
- ❌ ยังไม่ต้องแตะ EFI partition เพิ่ม
...
> Android คือโลกที่ยืดหยุ่น  
> ถ้าให้พื้นที่เขาอย่างเหมาะสม  
> เขาจะอยู่ร่วมกับระบบอื่นได้อย่างสงบ
